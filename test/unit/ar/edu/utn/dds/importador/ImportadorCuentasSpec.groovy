...
class ImportadorCuentasSpec extends Specification {
    ...
    void "parsear archivo"() {
        ...
        tmpMap.put(ImportadorCuentas.FECHA_DESDE_TAG,"2015-01-01")
        tmpMap.put(ImportadorCuentas.FECHA_HASTA_TAG, "2016-01-01")
        ...
        tmpMap.put(ImportadorCuentas.FECHA_DESDE_TAG,"2016-01-01")
        tmpMap.put(ImportadorCuentas.FECHA_HASTA_TAG, "2016-01-01")
