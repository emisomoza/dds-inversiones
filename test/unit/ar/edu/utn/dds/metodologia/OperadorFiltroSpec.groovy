...
class OperadorFiltroSpec extends Specification {
    ...
    def setup() {
        ...
        indicador = Indicador.from("indicador", "4*5+ind(indicador1)", "")
        def indicador1 = Indicador.from("indicador1", "cue(Cuenta1) * ind(indicador2)", "")
        def indicador2 = Indicador.from("indicador2", "4^2-5", "" )
